...
function title() {
	...
	console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Created By Yudha ]')}\n\n${chalk.red('Elaina Bot')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('@yudhasandi._')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+6285704347763')}\n`))
}
